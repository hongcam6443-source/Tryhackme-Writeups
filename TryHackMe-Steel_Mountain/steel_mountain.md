...
![image](images/Pasted%20image%2020260109093941.png)
...
![image](images/Pasted%20image%2020260109094450.png)
...
![image](images/Pasted%20image%2020260109101333.png)
...
![image](images/Pasted%20image%2020260109101859.png)
...
![image](images/Pasted%20image%2020260109102914.png)
![image](images/Pasted%20image%2020260109102927.png)
接下来我们开始发送payload，同时观察80端口的状态：
![image](images/Pasted%20image%2020260109130052.png)

结果port80没有任何反映，说明有两种可能，要么是指令有问题，要么是payload根本就没有送到，大概率是前一种，certuil是windows自带的一个下载工具，下面我们使用powershell命令来试试：
![image](images/Pasted%20image%2020260109130432.png)
但是80端口还是没反映，我们看看能不能ping通目标：
![image](images/Pasted%20image%2020260109130725.png)
...
![image](images/Pasted%20image%2020260109132522.png)
![image](images/Pasted%20image%2020260109132456.png)
...
![image](images/Pasted%20image%2020260109135516.png)
...
![image](images/Pasted%20image%2020260109144154.png)
接下来我们就可以执行下一次payload，让目标运行nc.exe回连我们监听的4444端口：
![image](images/Pasted%20image%2020260109144521.png)
pwned，我们终于拿到了shell！！！！！！！！！！！
...
![image](images/Pasted%20image%2020260109152419.png)
...
![image](images/Pasted%20image%2020260109152851.png)
![image](images/Pasted%20image%2020260109153012.png)
接下来我们把这个文件放到目标文件夹下面：
![image](images/Pasted%20image%2020260109153134.png)
然后我们在本机上再开一个监听端口：
![image](images/Pasted%20image%2020260109153257.png)
在目标机器上重启服务：
`sc stop AdvancedSystemCareService9`
`sc start AdvancedSystemCareService9`
接着我们就拿到了最高权限：
![image](images/Pasted%20image%2020260109153555.png)
